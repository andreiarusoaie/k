...
package org.kframework.backend.symbolic.transformers;

import org.kframework.backend.symbolic.SymbolicKompileBackend;
...
public class TagUserRules extends CopyOnWriteTransformer {
    ...
    public TagUserRules(Context context) {
        ...
        notSymbolicTags = ImmutableSet.of(
                ...
                Constants.ANYWHERE,
                SymbolicKompileBackend.NOTSYMBOLIC);
...
//        }
    ...
    public ASTNode visit(Rule node, Void _)  {
        ...
        if (node.getSource() instanceof FileSource && (!((FileSource)node.getSource()).getFile().
                getAbsolutePath().contains("include"))
                ) {
//
...
//            }
//
            node.getAttributes().add(Attribute.of(SymbolicKompileBackend.SYMBOLIC, ""));
